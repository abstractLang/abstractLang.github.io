...
`<type>` is the type that the function returns.
...
func writeText(string value) void {
	Std.Console.writeln("My string is: " + value)
}
func writeText([]char value) void {
	Std.Console.writeln("My string is: " + string.join(value))
}
func writeNumber(i32 value) void {
